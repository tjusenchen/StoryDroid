...
def run_IC3(apk_path):
    ...
    print 'Running IC3: ' + ic3Info
    return results_IC3, ic3Info
...
if __name__ == '__main__':
    ...
    # apk name, apk_name
    # defined package name, defined_pkg_name
    # used package name, used_pkg_name
    ...
    # decompile label, decompile_label
    # sign label, sign_label
    # install label, install_label
    ...
    for apk in os.listdir(apk_dir):
        if apk.endswith('.apk'):
            ...
            results_IC3, ic3_label = run_IC3(apk_path)
            ...
            all_acts, decompile_label, sign_label, install_label = run_rpk_explore_apk.execute(apk_path, apk_name, result_apkfolder, output)
            ...
            if all_acts != None:
                ...
                csv.writer(open(out_csv, 'a')).writerow((apk_name, defined_pkg_name, used_pkg_name, len(all_acts), ic3_label,
                                                         appearedActs_in_atgs_num, act_coverage,
                                                         independentActs_not_in_acts_num, all_atgs_num, scenarios_num, static_atgs_num, dynamic_atgs_num,
                                                         decompile_label, sign_label, install_label,
                                                         startup_acts_num , failed_startup_acts_num, failed_startup_acts))

            ''' # Comment on 2022.10.24, don't need the Java code
            print 'Start to decompile apk'
            decompile(apk_path, apk_name)
            
            # Comment on 2022.10.24, don't need the call graph
            ...
            # Comment on 2022.10.24, don't need the webpage info
