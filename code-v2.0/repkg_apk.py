...
def startRepkg(apk_path, apkname, apkresult_folder, output):
    ...
    for line in recompileInfo.split('\n'):
        # Not handle
        # W: /media/dell/49fff1d2-ef19-4e4d-855b-4eca95be873a/dell/Xiangyu/StoryDroid/main-folder/outputs/com.simplemobiletools.draw.pro_72/decompile/res/values-v31/colors.xml:3: error: Error: Resource is not public. (at 'm3_ref_palette_dynamic_neutral0' with value '@android:color/accent_device_default_700').
        if "Error: Resource is not public." in line and "AndroidManifest.xml" in line:
            print line
