...
var image = svg.append("g").selectAll("image")
    ...
    .on("click", (d) => {
        ...
        document.getElementById("h1").href = "output2" + "?name=" + d.name + "#sourceactcode"
        document.getElementById("h2").href = "output2" + "?name=" + d.name + "#sourcelayoutcode"
        document.getElementById("h3").href = "output2" + "?name=" + d.name
