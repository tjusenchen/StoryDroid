...
StoryDroid+ uses Flask to build an offline website, a lightweight customizable framework, written in Python, which is more flexible, lightweight, and secure.
* pip install flask
