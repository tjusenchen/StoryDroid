...
public interface IBluetooth extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetooth {
        ...
        private static class Proxy implements IBluetooth {
            ...
            public String getRemoteAlias(String address) throws RemoteException {
            ...
            public boolean setRemoteAlias(String address, String name) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    String _result = getRemoteAlias(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = setRemoteAlias(data.readString(), data.readString());
                    reply.writeNoException();
